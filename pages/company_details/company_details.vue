<template>
	<view class="body">
		<view class="content">
			...
			<!-- 头部层 -->
			<view class="head">
				<image class="background" src=../../static/company_details/web-1045994_1280.jpg></image>
			</view>	
			
			<!-- 卡片层 -->
			<view class="card">
				<view class ="font">
					<text class="Name">字节跳动</text>
					<image class="ic1" src=../../static/company_details/wodeqiye.png></image>
					<image class="logo" src=../../static/company_details/字节跳动.png></image>
				</view>
				<text class="text-grey">北京|C轮 200人以上|文娱|内容</text> 
				<text class="text2">公司介绍</text>
				<text class="tag">移动互联网</text>
				<text class='production_detail' :class= "modalName?'ellipsis':'unellipsis'">北京字节跳动科技有限公司成立于2012年3月，是最早将人工智能应用于移动互联网场景的科技企业之一。公司以建设“全球创作与交流平台”为愿景。字节跳动的全球化布局始于2015年，“技术出海”是字节跳动全球化发展的核心战略。</text>
			...
			<scroll-view scroll-x="true" class="scroll">
				<view class="box">
					<image src=../../static/index_pic/a0ca113c9c6d4fb49c9b8bb54a392a00_noop.png class="images"></image>
					<view class="main_product">
						<text class="main_product_name">抖音短视频</text>
						<view class="main_product_pro">抖音短视频,一个旨在帮助大众用户表达自我,记录美好生活的短视频分享平台.</view>
					</view>
				</view>
				<view class="box">
			...
			<view class="management">
				...
				<view class="pic_name">
					<image class="headpic" src=../../static/company_details/陈林.png></image>
					<view class="manage_name">
						<text class="manage_position">CEO\n</text>
						<text class="manege_com">今日头条</text>
					</view>
				</view>
				<view class="manage_intro">陈林。2012年3月，作为早期核心员工加入字节跳动，先后担任多款核心产品的产品经理，从产品经理成长为今日头条的总负责人。2018年11月起，陈林出任今日头条CEO一职2019年，成为字节跳动创新业务负责人。</view>
			</view>	
			...
			<!-- 公司网站 -->
			<view class="website">
				<text class="text2">公司官网\n</text>
				<view class="web">http://www.bytedance.com</view>
			</view>
			...
			<view class="ic">
				...
				<view class="ic_infor">
					<view class="line1">
						...
						<view class="ic_detail">北京字节跳动科技有限公司</view>
					</view>
					<view class="line1">
						<view class="ic_title">成立时间</view>
						<view class="ic_detail">2012-03-09</view>
					</view>
					<view class="line1">
						<view class="ic_title">注册资本</view>
						<view class="ic_detail">1000万人民币</view>
					</view>
					<view class="line1">
						<view class="ic_title">法人代表</view>
						<view class="ic_detail">张利东</view>
					</view>
				</view>	
			</view>
		</view>	
		...
		<view class="bottom">
				<view class="collect">
					<image class="collect_pic" src=../../static/company_details/收藏.png></image>
					<view class=bottom_word1>收藏企业</view>
				</view>
				<view class="divLine2"></view>
				<view class="share">
					<image class="share_pic" src=../../static/company_details/分享.png></image>
					<view class=bottom_word2>分享</view>
				</view>
				<navigator url="/pages/jobbrowse/jobbrowse">
					<view class="toview">
